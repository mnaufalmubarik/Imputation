...
imputer.fit(X)
X_imputed_df = imputer.transform(X)
X_imputed_df = pd.DataFrame(X_imputed_df, columns=X.columns)

# access the imputed X1 column
X1_i = X_imputed_df['LIMS:1110SUEZ0002.SALT']
X2_i = X_imputed_df['LIMS:1110SUEZ0005.SALT']
X3_i = X_imputed_df['LIMS:1110SUEZ0005.BSW CRUDE']
X4_i = X_imputed_df['LIMS:1110SUEZ0007.SALT']
X5_i = X_imputed_df['LIMS:1110SUEZ0010.BSW CRUDE']
X6_i = X_imputed_df['LIMS:1110SUEZ0010.SALT']
X7_i = X_imputed_df['LIMS:1110SUEZ0016.Cl']
X8_i = X_imputed_df['LIMS:1110SUEZ0016.pH']
X9_i = X_imputed_df['LIMS:1110SUEZ0016.Tfe']

# print the imputed X1
print('The new X1 is \n', X1_i)

# 2nd Check for missing data
missing_data = X_imputed_df.isnull().sum()
print(missing_data)
...
plt.savefig(os.path.join(folder_path, 'LIMS:1110SUEZ0002.SALT - Random Forest.png'))
plt.close()
