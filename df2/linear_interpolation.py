...
# Imputation
X_interpolated = X.interpolate(method='polynomial', order=2, limit_direction='both')
...
plt.savefig(os.path.join(folder_path, 'LIMS:1110SUEZ0002.SALT - Linear Interpolation.png'))
plt.close()
