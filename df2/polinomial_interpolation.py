...
# Imputation
X_interpolated = X.interpolate(method='linear', limit_direction='both')
...
plt.savefig(os.path.join(folder_path, 'LIMS:1110SUEZ0002.SALT - Polinomial Interpolation.png'))
plt.close()
